...
@section('profile.content')
    <div x-data="cityInput" class="col-sm-12 col-lg-9">
        ...
        <form action="{{ route('addresses.Update', ['address' => $address->id]) }}" method="POST" class="card card-body">
            @csrf
            @method('PUT')
            <div class="row g-4">
            ...
            <div>
                ...
                <a href="{{ route('profile.addresses') }}" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">بازگشت</a>
            </div>
        </form>
    </div>
@endsection
